...
import { LayoutDashboard, Package, Users, ShoppingBag, Palette, ScrollText, ClipboardCheck, Sparkles, MessageSquare } from "lucide-react";
...
const items = [
  ...
  { title: "Chat oversight", url: "/admin/chats", icon: MessageSquare },
